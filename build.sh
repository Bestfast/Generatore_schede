...
sudo x86_64-w64-mingw32-g++ -std=gnu++11 main.cpp -static-libgcc -static-libstdc++ -L/usr/x86_64-w64-mingw32/lib -l:/usr/x86_64-w64-mingw32/lib/sqlite3.dll  -o Generatore_Schede_winX64.exe 
mkdir -p build/win64
sudo mv Generatore_Schede_linuxX64 db.sqlite build/
sudo cp /usr/x86_64-w64-mingw32/lib/sqlite3.dll $PWD/build/win64/sqlite3.dll
sudo mv Generatore_Schede_winX64.exe build/win64/Generatore_Schede_winX64.exe
