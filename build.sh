...
sudo i686-w64-mingw32-g++ -std=gnu++11 main.cpp -static-libgcc  -static -lpthread -static-libstdc++ -L/usr/i686-w64-mingw32/lib -static -l:/usr/i686-w64-mingw32/lib/sqlite3.dll -Wl,-Bdynamic  -o Generatore_Schede_winX32.exe 
mkdir -p build/win32
mkdir -p build/linux64
sudo mv Generatore_Schede_linuxX64 db.sqlite build/linux64/
sudo cp /usr/i686-w64-mingw32/lib/sqlite3.dll $PWD/build/win32/sqlite3.dll
sudo mv Generatore_Schede_winX32.exe build/win32/Generatore_Schede_winX32.exe
