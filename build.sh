...
sudo i686-w64-mingw32-g++ -std=gnu++11 main.cpp -static-libgcc  -static -lpthread -static-libstdc++ -L/usr/i686-w64-mingw32/lib -static -lsqlite3 -Wl,-Bdynamic  -o Generatore_Schede_winX32.exe 
mkdir -p build/win32
