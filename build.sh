...
sudo i686-w64-mingw32-g++ -std=gnu++11 main.cpp -static-libgcc -static-libstdc++ -L/usr/i686-w64-mingw32/lib -l:/usr/i686-w64-mingw32/lib/sqlite3.dll  -o Generatore_Schede_winX32.exe 
mkdir -p build/win32
...
sudo mv Generatore_Schede_winX32.exe build/win32/Generatore_Schede_winX64.exe
